...
App.controller('oneCtrl', function($scope, $q, $modal) {
  ...
  $scope.membersList = [
    { 'rating': 4, 'firstName': 'Ram', 'lastName': 'Shinde', 'drag': true },
    { 'rating': 2, 'firstName': 'Shyam', 'lastName': 'Bhosale', 'drag': true },
    { 'rating': 6,  'firstName': 'Ramesh', 'lastName': 'Jadhav', 'drag': true },
    { 'rating': 5,  'firstName': 'Nakul', 'lastName': 'Shinde', 'drag': true },
    { 'rating': 1,  'firstName': 'Ganesh', 'lastName': 'Dhage', 'drag': true }
  ];

  // Limit items to be dropped in list1
  /*$scope.optionalProjectsList = {
    accept: function(dragEl) {
      console.log("$scope.projectsList : "+$scope.projectsList.length);
      console.log($scope.projectsList);
      return true;
      // if ($scope.projectsList.length >= 2) {
      //   return false;
      // } else {
      //   return true;
      // }
  ...
  $scope.beforeDrop = function() {
    ...
    /*modalInstance.result.then(function (data) {
      ...
      console.log('Member model dismissed at: ' + new Date());
      return false;
    });*/
